...
List<MusicModal> musicModalFromJson(String str) =>
    List<MusicModal>.from(json.decode(str).map((x) => MusicModal.fromJson(x)));

class MusicModal {
  Results results;

  MusicModal({this.results});

  MusicModal.fromJson(Map<String, dynamic> json) {
    results =
...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json) {
    opensearchQuery = json['opensearch:Query'] != null
        ? new OpensearchQuery.fromJson(json['opensearch:Query'])
        : null;
    ...
    albummatches = json['albummatches'] != null
        ? new Albummatches.fromJson(json['albummatches'])
        : null;
